        ...
        return (
            <div className="min-h-screen pt-28 pb-20 bg-background flex items-center justify-center">
                ...
                <div className="relative z-50 bg-white border border-(--color-border) p-10 max-w-md w-full mx-4 text-center animate-fade-in-up">
                    ...
                    {orderRef && (
                        <p className="text-xs text-gray-400 mb-6">Reference: {orderRef}</p>
                    )}
                    {!orderRef && <div className="mb-6" />}
                    <button
                        onClick={() => router.push("/search")}
                        className="w-full bg-black text-white py-4 text-xs font-bold uppercase tracking-widest hover:bg-[#333] transition-all"
                    >
                        Continue Shopping
                    </button>
                </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white border border-(--color-border) p-6 lg:sticky lg:top-28">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="w-full mt-6 bg-black text-white py-4 text-xs font-bold uppercase tracking-widest hover:bg-[#333] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
